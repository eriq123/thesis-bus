...
class UserBookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mybookings.index')->withSuccess('Added Successfully!');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('mybookings.index')->withSuccess('Updated Successfully!');
    }

    public function destroy($id)
    {
        Booking::destroy($id);
        return redirect()->route('mybookings.index')->withSuccess('Deleted Successfully!');
    }
}
